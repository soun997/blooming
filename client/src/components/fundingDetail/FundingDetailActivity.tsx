...
import {
  ...
  pastActivity,
  // concertDetail,
} from '@type/ActiveDetail';

interface Props {
  artistData: artist;
  activityData: activity;
  investmentData: investment;
  pastActivitiesData: pastActivity[];
...
const FundingDetailActivity: React.FC<Props> = ({
  artistData,
  activityData,
  investmentData,
  pastActivitiesData,
  ...
  const data2 = {
    ...
    //   ['B-Side', '2022-01-01'],
    // ],
    labels: pastActivitiesData.map((activity) => [
      activity.name,
      activity.publishedDate.split('T')[0],
    ]),
    datasets: [
      {
        label: '수익률 (%)',
  ...
  // console.log(
  //   `pastConcertData: ${pastConcertsData.map((activity) => [
  //     activity.name,
      ...
      <DetailBox>
        <AlbumInfoBox ref={albumInfoRef}>
            ...
            <VideoBox>
              <iframe
                ...
                src={`https://www.youtube.com/embed/${
                  activityData.teaserVideoUrl.split('v=')[1]
                }`}
          ...
          <img
            ...
            src={activityData.albumCompositionImg}
            alt=""
...
export default FundingDetailActivity;

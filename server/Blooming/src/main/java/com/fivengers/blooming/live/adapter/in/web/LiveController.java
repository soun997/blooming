...
public class LiveController {
    ...
    public ApiResponse<List<LiveListResponse>> LiveListByKeyword(SearchRequest searchRequest) {
        // TODO : searchRequest Validation
        List<LiveListResponse> liveResponseList = liveSearchUseCase.searchByKeyword(searchRequest)

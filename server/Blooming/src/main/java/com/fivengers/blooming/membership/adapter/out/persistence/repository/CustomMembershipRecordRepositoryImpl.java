...
@Repository
public class CustomMembershipRecordRepositoryImpl
        extends QuerydslRepositorySupport implements CustomMembershipRecordRepository {

    public CustomMembershipRecordRepositoryImpl() {
        super(MembershipRecordJpaEntity.class);
    }

    public List<MembershipRecordJpaEntity> findByMembershipIdOrderByStartDateDesc(
            Long membershipId, Long limit) {

...
public class LiveControllerAdvice {
    ...
    public ApiResponse<ErrorResponse> constraintViolation(
            OpenviduWebHookNotFoundException exception) {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ApiResponse<ErrorResponse> UnauthorizedMemberForClosingLive(
            UnauthorizedMemberForClosingLiveException exception) {
        AdviceLoggingUtils.exceptionLog(ExceptionCode.UNAUTHORIZED_MEMBER_FOR_CLOSING_LIVE, exception);
